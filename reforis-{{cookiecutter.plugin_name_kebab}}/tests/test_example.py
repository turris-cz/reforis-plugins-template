...
from .utils import get_mocked_{{cookiecutter.plugin_name_snake}}_client


def test_get_example(app):
    backend_response = {'key': 'value'}
    with get_mocked_{{cookiecutter.plugin_name_snake}}_client(app, backend_response) as client:
